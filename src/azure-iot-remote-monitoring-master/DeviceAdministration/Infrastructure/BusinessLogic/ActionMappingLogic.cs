...
namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.DeviceAdmin.Infrastructure.BusinessLogic
{
    public class ActionMappingLogic : IActionMappingLogic
    {
        ...
        private const string _ruleOutputAlarmREAR_TPM = "AlarmREAR_TPM";
        private const string _ruleOutputAlarmFRONT_TPM = "AlarmFRONT_TPM";
        private const string _ruleOutputAlarmBETTERY_VOLT = "AlarmBETTERY_VOLT";

        private List<string> _availableRuleOutputs = new List<string>() 
        {
            _ruleOutputAlarmTEMP,
            _ruleOutputAlarmREAR_TPM,
            _ruleOutputAlarmFRONT_TPM,
            _ruleOutputAlarmBETTERY_VOLT
        };
