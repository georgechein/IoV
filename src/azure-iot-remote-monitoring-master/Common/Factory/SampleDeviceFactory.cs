...
namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.Common.Factory
{
    public static class SampleDeviceFactory
    {
        ...
        {
            device.Telemetry.Add(new Telemetry("TEMP", "TEMP", "double"));
            device.Telemetry.Add(new Telemetry("REAR_TPM", "REAR_TPM", "double"));
            device.Telemetry.Add(new Telemetry("FRONT_TPM", "FRONT_TPM", "double"));
            device.Telemetry.Add(new Telemetry("BETTERY_VOLT", "BETTERY_VOLT", "double"));
        }
